...
@section('main')
@push('title')
<title> {{ trans('messages.edit_booking_lang',[],session('locale')) }}</title>
@endpush
<!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">{{ trans('messages.edit_booking_lang',[],session('locale')) }}</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{ trans('messages.pages_lang',[],session('locale')) }}</a></li>
                                <li class="breadcrumb-item active">{{ trans('messages.edit_booking_lang',[],session('locale')) }}</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('add_booking') }}" class="add_booking" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" class="booking_id" value="{{ $booking_data->id }}" name="booking_id">
                                <input type="hidden" class="total_paid_payment" value="{{ $total_paid_payment }}" name="total_paid_payment">
                                {{-- <div class="row">
                                    <div class="col-md-2">
                                        <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control customer_name" name="customer_name" type="text" value="{{ $customer_data->id.'-'.$customer_data->customer_name.'+'.$customer_data->customer_number }}" id="customer_name">
                                            <input class="form-control customer_id" value="{{ $customer_data->id }}" name="customer_id" type="hidden" id="customer_id">
                                        </div>
                                    </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control dress_name" data-trigger name="dress_name" id="dress_name" onchange="get_dress_detail()">
                                                <option value="">{{ trans('messages.choose_lang',[],session('locale')) }}</option>
                                                @foreach ($view_dress as $dress)
                                                    @php
                                                        $selected = ($dress->id == $booking_data->dress_id) ? 'selected' : '';
                                                    @endphp
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control price isnumber" name="price" type="text" value="{{ $booking_data->price }}" id="price">
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label for="discount" class="form-label">{{ trans('messages.discount_lang',[],session('locale')) }} %</label>
                                            <input class="form-control discount isnumber" name="discount" value="{{ $booking_data->discount }}" type="text" id="discount">
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label for="total_price" class="form-label">{{ trans('messages.total_price_lang',[],session('locale')) }} %</label>
                                            <input class="form-control total_price isnumber" name="total_price" value="{{ $booking_data->total_price }}" type="text" id="total_price" readonly>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control notes" name="notes" rows="5">{{ $booking_data->notes }}</textarea>
                                        </div>
                                    </div> 
                                </div>
                                <div class="row">
