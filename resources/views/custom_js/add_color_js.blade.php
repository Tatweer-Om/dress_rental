<script type="text/javascript">
    $(document).ready(function() {
        $('#add_color_modal').on('hidden.bs.modal', function() {
            $(".add_color")[0].reset();
            $('.color_id').val('');
        });
        $('#all_color').DataTable({
            "sAjaxSource": "{{ url('show_color') }}",
            "bFilter": true,
            'pagingType': 'numbers',
            "ordering": true,
        });
            ...
            if(id!='')
            {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#all_color').DataTable().ajax.reload();
                        return false;
                    },
                    error: function(data)
                    {
